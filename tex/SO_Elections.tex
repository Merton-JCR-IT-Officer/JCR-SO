\chapter{Elections} \label{ch:elections}
...
\section{Returning Officer} \label{sec:RO}
...
\npara \label{SO:ROCandidacy} The Returning Officer shall never be a Candidate.
...
\section{Eligibility for Candidature} \label{sec:CandidatureEligibility}
\npara Subject to S.O. \ref{SO:ROCandidacy} and the following clauses, any Ordinary Member shall be eligible to stand for Election to any post on the JCR Committee, or where applicable, any seat on Sub-Committees or Standing Committees.
% * <julesdesai14@gmail.com> 2018-09-25T14:42:40.627Z:
% 
% > S.O. 4.5.6
% Need to link
% ^ this comment was left by Jules Desai (2016) PhysPhil, apparently. I've fixed it. - <Wilfred Lamont (2023) German & Linguistics>  2025-06-30
...
\section{Manifestos} \label{sec:manifestos}
...
\section{Hustings} \label{sec:hustings}
...
\section{Canvassing} \label{sec:canvassing}
...
\subsection{Executive Committee Elections} \label{ssec:ExecCommitteeElections}
...
\item Should RON gain over 50\% of the valid votes at any stage of the counting procedure then the procedure detailed in S.O. \ref{SO:RONVictory} shall be followed.
\item In the event of a tie, the Candidate with the highest number of first preferences shall be declared elected. If a tie is still the result, then the Candidate with the greatest number of second preferences shall be declared elected, and so on. If the result is still a tie once all the preferences have been taken into account, RON shall be deemed to have won and a second Election shall be held following the procedure detailed in S.O. \ref{SO:RONVictory}
\end{enumerate}
...
\begin{enumerate}
\item Candidates running for Joint Election should run in pairs and choose a Slate name to run under.
\item Voting shall be by the system of a Single Transferable vote and must be in order of preference, expressed numerically with 1 expressing the first preference, 2 the second preference and so on for as many preferences as the voter wishes to express or until there are no remaining Slates.
\item The ballot shall list all slates in alphabetical order by Slate name, and RON which always appears last.
\item Any indication of a vote for a Slate, where there is only one such indication, shall be deemed a first preference vote for that Slate.
...
\item The count shall be conducted in accordance with the ERS97 system explained in Appendix \ref{App:STV}.
\item If RON is amongst the Candidates deemed elected, the result of the Election shall be annulled and the procedure in S.O. \ref{SO:RONVictory} shall be followed.
\end{enumerate}
...
\npara \label{SO:RONVictory} If RON wins in the case of the Presidency or an Executive Committee position, nominations shall re-open for a period of three Term-time Days, Hustings shall occur on the fourth Term-time Day and Polling shall be held seven Term-time Days after the original Election. All rules concerning the content and display of Manifestos and the conduct of Hustings and Polling shall be adhered to.
\npara If no Candidate stands by close of nominations, RON shall be deemed to have won.
\subsection{OGM Elections} \label{ssec:OGMElections}
...
\npara All Candidates must meet the eligibility criteria set out in S.O. \ref{sec:CandidatureEligibility} and provide Manifestos adhering to the rules of content and display set out in S.O. \ref{sec:manifestos} Canvassing in accordance with S.O \ref{sec:canvassing} is allowed.
...
\section{Complaints}
\npara Complaints concerning Elections shall be dealt with in accordance with S.O. \ref{ch:complaints}.
