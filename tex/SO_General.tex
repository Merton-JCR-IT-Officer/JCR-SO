...
\npara \label{SO:appendices} Appendices shall have force only to the extent that they are given force by one or more references to each Appendix in the Standing Orders.  Amendment of an Appendix shall be considered as an amendment of the applicable reference or references in the Standing Orders.
