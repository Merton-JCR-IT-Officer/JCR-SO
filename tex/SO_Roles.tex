...
\begin{enumerate}
	...
	\item Arts and Publications Representative
    ...
    \item First-Year Student's Representative
\end{enumerate}
...
\begin{enumerate}
	...
	\item Acting as the Chair of the General Meeting, in accordance with S.O. \ref{gm:chair}.     
	\item Convening and chairing meetings of the Executive Committee, and compiling the agenda for these meetings, in accordance with S.O. \ref{com:exec} and Article \ref{Art:TrusteeDecisions}.
	\item Communicating JCR policy to the College, including attending the meetings of the following: Governing Body, Domestic Committee, Warden and Tutors' Committee, and Development Committee.
	...
	\item Advancing the interests of the JCR externally to the Presidents' Committee; acting as the voting member as the Merton JCR Representative at the Conference of Common Rooms; and, in association with the Affiliated Organisations and Careers Representative, any organisation to which the JCR chooses to affiliate itself under S.O. \ref{ch:affiliations}.
	...
	\item Organising and coordinating the Time Ceremony in association with the Executive Committee and MCR President; producing a written report on the Time Ceremony, including recommendations for improvement.
	...
	\item Attending the meetings of the Junior Members' Charities Committee (Appendix \ref{App:CharitiesArtsFunds}).
...
\begin{enumerate}
    ...
    \item Acting as Secretary to the General Meeting subject to S.O. \ref{gm:secretary} and Article \ref{Art:Minutes} on behalf of the Executive Committee.
    ...
    \item Acting as Secretary to the Executive Committee subject to S.O. \ref{com:exec}.
    \item Acting as Secretary to the JCR Committee subject to S.O. \ref{com:jcr}.
    \item Liaising with College over accommodation, including conducting the Room Ballot according to the procedure set out in Appendix \ref{App:RoomBallot} and maintaining the room database which is to be updated annually.
    ...
    \item Acting as the Designated Officer the Environment Representative and the Information Technology Officer.
\end{enumerate}

\section{Treasurer}
\npara The Treasurer shall be responsible for the day-to-day management of the JCR's finances, by and with the consent of the Executive Committee in accordance with Article \ref{Art:Finances} of the Constitution and S.O. \ref{ch:finances}, and advising the JCR on financial matters.
...
\npara \label{resp:access-rep} In addition to any other responsibilities provided for by the Constitution and Standing Orders, the responsibilities of the Access and Equal Opportunities Representative shall include those listed below.
\begin{enumerate}
	...
	\item Acting as the Designated Officer for the Disabled Students’ Representative, the Ethnic Minority Students’ Representative, the Gender Equality Representative, the International Students’ Representative, the LGBTQIA+ Representative, the Transgender Representative, the Social Backgrounds Representative, and the First-Year Students' Representative.
	...
	\item \label{SC:freshers-guide} Responsibility for writing (or editing and improving the previous year's) Freshers guide over the Trinity vac, working with the President and College to produce a useful, engaging, and preferably entertaining document.
\end{enumerate}
\npara When organising Open Days and coordinating the selection of Student Ambassadors to represent the College at them, using their best endeavours to ensure that, so far as the number and suitability of international applicants allows, international students are represented among the Ambassadors present at each Open Day in a proportion broadly reflecting the proportion of international students among the JCR’s undergraduate membership at that time, so that prospective international applicants are appropriately represented; and consulting the International Students’ Representative in giving effect to this. 
...
\begin{enumerate}
	...
	\item \label{SC:parenting-scheme} Organising the JCR parenting scheme.
...
\begin{enumerate}
	\item Advancing the interests of the JCR to organisations to which the JCR is affiliated under S.O. \ref{ch:affiliations}, in association with the President.     
	...
	\item Ensuring that, as far as possible there is Merton representation at all external committees organised by Affiliated Organisations.
	\item Once a year, hosting a ‘Alumni Formal’ event at Merton, with possible support from the President and/or the Academic Affairs representative.
	\item Once a year, hosting a formal swap with Peterhouse College Cambridge, with possible support from the President and/or the Academic Affairs representative.
\end{enumerate}
\section{Arts and Publications Representative}
...
\begin{enumerate}
	...
	\item Convening and Chairing the JCR Arts Sponsorship Fund Committee (see Appendix \ref{AppSec:ArtsFund})
...
\begin{enumerate}
	...
	\item Convening and co-chairing a meeting of the Junior Members Charities Committee at least once a term (Appendix \ref{App:CharitiesArtsFunds}).
	...
	\item Maintaining the JCR Food Bank in the Pidge Room, ensuring that all food items are donated in week 8 of each term, and publicising it in emails to the JCR.
\end{enumerate}
...
\begin{enumerate}
	...
	\item Attending Peer Support Training, conditional on availability of excess course places.
	\item Promoting the Annual Disability Formal with College.
	\item Ensuring that, as far as possible, there is a Merton presence at all external committees convened by Affiliated Organisations for the consideration and advancement of Disabled Students' issues.
\end{enumerate}
...
\begin{enumerate}
	...
	\item Organising the JCR Christmas Dinners with the Disabled Students Rep.
	\item Organising the annual JCR Formal Swap with Peterhouse College, Cambridge.
...
\begin{enumerate}
	...
	\item Aiding the Access and Equal Opportunities Representative with the organisation of Open Days with a view to encouraging applications from international students, including working with the Access and Equal Opportunities Representative to secure appropriate representation of international students among Student Ambassadors at Open Days in accordance with S.O. \ref{resp:access-rep}. 
	...
	\item Organising the International Parenting Scheme, in coordination with the Welfare Officers, as an extension of and without altering the JCR parenting scheme under S.O. \ref{resp:welfare-officers}.\ref{SC:parenting-scheme}, so that every international first-year undergraduate has at least one international student, besides the International Students’ Representative, whom they can approach. To that end, the International Students’ Representative shall: 
    \begin{enumerate}
        \item  Assign one returning international student (an ‘International Godparent’) to each international first-year undergraduate who does not have an international student among their college parents, as an additional point of contact on matters relating to being an international student;
        \item So far as volunteers allow, keep the number of students any one International Godparent supports small, sharing the role between volunteers rather than overloading anyone, and may provide support themselves where volunteers are too few; and 
        \item In conjunction with the Welfare Officers, hold at least one event early in Michaelmas Term at which international students can meet and get to know one another, held separately from the JCR parenting scheme.
    \end{enumerate}
	\item Writing and editing the International Freshers' Guide.
	\item Organising, in association with the Executive Committee, a programme for international students which shall begin on the Thursday immediately before the official Freshers’ Week (as defined in Appendix \ref{App:InternalDefs}) and continue until the commencement of Freshers’ Week. 
...
\section{First-Year Students' Representative}
\npara The First-Year Students’ Representative shall be responsible for representing and advancing the interests of first-year undergraduates within the JCR, the College, and the University.

\npara  In each term, the Scheduled Election for the First-Year Students’ Representative shall be in the second OGM.

\npara In addition to any other responsibilities provided for by the Constitution and Standing Orders, the responsibilities of the First-Year Students’ Representative shall include those listed below.
\begin{enumerate}
    \item Acting to increase first-year attendance at OGMs. 
    \item Acting to increase the accessibility of official JCR proceedings to first-year undergraduates by, where required, assisting with and looking over motions proposed by first-year undergraduates.
    \item Aiding the Access and Equal Opportunities Representative in the writing (or editing and improving the previous year’s) Freshers’ Guide (see Standing Order \ref{resp:access-rep}.\ref{SC:freshers-guide}).
    \item Representing the JCR on external committees convened by Affiliated Organisations for the consideration and advancement of issues related to first-year undergraduates and reporting back to the JCR on any issues arising.
    \item Contributing to and advising the Executive Committee on a programme for freshers during the official Freshers’ Week. 
    \item Providing information and support about, and lobbying for better provision of, services relevant to first-year undergraduates, including but not limited to finance, funding, vacation residence, and storage. 
\end{enumerate}
