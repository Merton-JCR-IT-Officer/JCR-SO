\chapter{Committees} \label{ch:committees}
...
\npara Appendices \ref{App:InternalDefs} (Internal Definitions) and \ref{App:WinterBall} (Merton Winter Ball Standing Committee) shall have binding effect.
...
\section{The Executive Committee} \label{com:exec}
...
\npara \label{SO:BusinessReport} A report of all business transacted by the Executive Committee since the last meeting shall be made to the JCR Committee or General Meeting on request.
...
\npara Arranging a further, group, handover session between the outgoing and incoming Executive Committees prior to the latter taking up office. This shall supplement and not replace the personal handover required in S.O. \ref{resp:general}.\ref{SC:handover}.
...
\section{The JCR Committee} \label{com:jcr}
\subsection{Procedure}
...
\begin{enumerate}
	...
	\item Notices
	\item \label{exec_business}Executive Committee Business (see S.O. \ref{SO:BusinessReport}.)
	...
	\item \label{SC:TransactedBusinessCommittees} Sub-Committee (see S.O. \ref{resp:subcommittee}) and Standing Committee (see S.O. \ref{resp:StandingCommittee}) Business
	\item Any other business
\end{enumerate}
\npara \label{SO:PresentBusinessReport} The Executive Committee shall present a report of recent business as in S.O. \ref{SO:BusinessReport}, omitting the details of any confidential business.
...
\subsection{Responsibilities}
\npara \label{resp:general} Each member of the JCR Committee shall undertake the following responsibilities.
\begin{enumerate}
...
\end{enumerate}
\subsection{Powers}
\npara The power to request information from the Executive Committee in accordance with S.O. \ref{SO:PresentBusinessReport}.
...
\subsection{Associate Members and the Committee Chair} \label{ssec:AssociateMembersAndCommitteeChair}
...
\npara The Chair shall give a report of business transacted by the Standing Committee at meetings of the JCR Committee during the section of the meeting designated "Sub-Committee and Standing Committee Business" (S.O. \ref{transacted_business}.\ref{SC:TransactedBusinessCommittees}).
\subsection{Responsibilities}
\npara \label{resp:StandingCommittee} The Standing Committee shall be directly responsible to the General Meeting and the Chair shall provide regular reports to the General Meeting and to the JCR Committee.
...
\section{Permanent Sub-Committees of the Executive Committee} \label{sec:PermanentSubCommittees}
...
\npara Where relevant, volunteering Members approved by the Chair hold membership of the Sub-Committee for one year from the date of first attendance at the Committee, unless this is curtailed in accordance with S.O. \ref{ch:ResignationRemoval}.
...
\section{Resignation and removal} \label{ch:ResignationRemoval}
...
\npara Ratification of a motion of no confidence in a Trustee to remove them from the Executive Committee shall be by Referendum, in accordance with S.O.\ref{ch:referenda}.  The passing of such a motion of no confidence by the General Meeting shall be considered a call for a Referendum.
...
\end{enumerate}
\npara Immediately the Executive Committee gives notice to an Office-Holder that they have been suspended, the Office-Holder shall be relieved of the relevant duties and responsibilities and shall be prohibited from purporting to act in that office, subject to S.O. \ref{SO:TrusteeSuspensionRights}.
\npara \label{SO:TrusteeSuspensionRights} If a Trustee is suspended, they retain the right to attend, speak and vote at meetings of the Executive Committee and its Sub-Committees, subject to the Constitution and Standing Orders.
