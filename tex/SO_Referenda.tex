\chapter{Referenda} \label{ch:referenda}
...
\npara \label{SO:ReferendumCall} A Referendum may be called by:
\begin{enumerate}
...
\item Members in accordance with the procedure set out in S.O. \ref{ch:affiliations}.
\end{enumerate}
...
\section{Voting} \label{sec:ReferendumVoting}
...
\section{Complaints}
\npara Complaints concerning Referenda shall be dealt with in accordance with S.O. \ref{ch:complaints}.
